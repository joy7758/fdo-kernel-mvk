...
State = Dict[str, int]
DEFAULT_BUNDLE = Path(__file__).resolve().parents[1] / "examples" / "output" / "audit_bundle.json"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m kernel.verify",
        description="Verify a replay bundle generated by the MVK demo.",
    )
    parser.add_argument("bundle", nargs="?", default=str(DEFAULT_BUNDLE))
    args = parser.parse_args(argv)
    return 0 if verify_bundle(args.bundle) else 1
